    ...
    def __init__(self):
        ...
        try:
            self.args = self.parse_args([
                '-m', '-i', 'git', '--path', '/home/mahen/flutter/.git', '-dbms', 'sqlite',
                '-DB', 'flutter', '-dbo', '/home/mahen/PycharmProjects/GRAS/flutter.db', '-RN', 'flutter', '-RO',
                'flutter', '-t',
                ...
                "35f9e0119a95659796352f9421e710d3da612e42",
                "e16c4981d641968a0cafea631682f3181ebe8fee",
                "a3ec1d0b1e54ee6552c7f1d0047888ff19e09b1d"
            ])
