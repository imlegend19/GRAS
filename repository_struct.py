...
def object_decoder(dic) -> Repository:
    obj = Repository(
        ...
        url=dic[RepositoryStatic.URL],
        created_at=dic[RepositoryStatic.CREATED_AT],
        updated_at=dic[RepositoryStatic.UPDATED_AT],
        description=dic[RepositoryStatic.DESCRIPTION],
